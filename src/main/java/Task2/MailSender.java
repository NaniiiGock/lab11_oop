...
public class MailSender {
    public void send(MailInfo mailInfo) throws MailjetSocketTimeoutException, MailjetException
    {
        ...
        client = new MailjetClient(System.getenv("376209cc2d20b7001e4352e9d6f75d16"), System.getenv("c039d5024ed9fd632d51aa81d18fb0b1"), new ClientOptions("v3.1"));

        request = new MailjetRequest(Emailv31.resource)
                                .property(Emailv31.MESSAGES, new JSONArray()
                                .put(new JSONObject()
                                .put(Emailv31.Message.FROM, new JSONObject()
                                .put("Email", "nanigock@gmail.com")
                                .put("Name", "Liliana"))
                                .put(Emailv31.Message.TO, new JSONArray()
                                .put(new JSONObject()
                                .put("Email", "liliana.hotsko@ucu.edu.ua")
                                .put("Name", "Liliana")))
